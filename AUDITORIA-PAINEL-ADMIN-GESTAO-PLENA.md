...
1. **Atendimento presencial** (documentos, impressão, MEI, IRPF) — ciclo de minutos,
   pagamento na hora. Já tem preço fixo em `TABELA-DE-PRECOS-E-FERRAMENTAS.md`.
...
`TABELA-DE-PRECOS-E-FERRAMENTAS.md` é a fonte de verdade dos preços do negócio 1, mas
