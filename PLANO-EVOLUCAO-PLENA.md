...
- Tirar do versionamento os binários grandes: `deploy-plena-atualizado-2026-07-31.zip` (20 MB), `gestao-barbearia.zip`, e avaliar `logoplena.svg` (4,7 MB — precisa de otimização).
...
1. **Auditor contínuo (baixo risco — início ideal)**
   - Varredura agendada: links quebrados, imagens ausentes, erros de console, mojibake/encoding, consistência de preços contra `TABELA-DE-PRECOS-E-FERRAMENTAS.md`.
