// ==========================================
// MÓDULO ORDENS DE SERVIÇO (O.S.) E DASHBOARD
// ==========================================
...
function renderChart() {
    const chartÁrea = document.getElementById('chart-área');
    if(!chartÁrea) return;
    ...
    chartÁrea.innerHTML = chartHTML || '<p class="text-gray-400 text-sm">Sem dados para exibir</p>';
}
...
function printOSDualLayout() {
    ...
    const viaAssistência = clone.querySelector('.text-center.mt-6');
    if(viaAssistência) viaAssistência.innerHTML = '---------- VIA DO CLIENTE & ASSISTÊNCIA ----------';
