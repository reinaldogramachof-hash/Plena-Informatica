...
function downloadBackup() { const dataStr = "data:text/json;charset=utf-8," + encodeURIComponent(JSON.stringify(db)); const a = document.createElement('a'); a.href = dataStr; a.download = "gestão_beleza_backup.json"; document.body.appendChild(a); a.click(); a.remove(); showToast('Backup realizado!'); }
