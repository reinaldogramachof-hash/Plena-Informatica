...
// Busca notificações em sistemasdegestão.tech/api_notificacoes.php
// ============================================================

const NOTIF_API_URL   = window.location.hostname === 'localhost' || window.location.hostname === '127.0.0.1' ? '../../api_notificacoes.php' : 'https://sistemasdegestão.tech/api_notificacoes.php';
